...
function rubik_cube_3:item_function/use/item_function/set_temp_cube

#初始化大小
execute unless data storage rubik_cube_3:io cube_scale run data modify storage rubik_cube_3:io cube_scale set value 1.0f
execute as @e[type=text_display,tag=rubik_cube_3_,tag=rubik_cube_3_is_temp_rube,distance=...01,tag=!rubik_glowing] run function rubik_cube_3:modify_scale/2_spe.2
