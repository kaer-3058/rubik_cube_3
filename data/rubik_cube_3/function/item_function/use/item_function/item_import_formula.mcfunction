...
execute as @a[tag=rubik_cube_3_sstempi] run item replace block -29999984 -60 22022220 container.0 from entity @s weapon.mainhand

tag @s add rubik_cube_3_is_import_formula
data modify entity @s data merge value {rotation:{interpolation_duration:4,whole_cube:false},temp_import_formula:{list:[],opposite:false}}
...
tellraw @a [{text:"位于",color:"gray",italic:true},{nbt:"temp2",storage:"rubik_cube_3:io",color:"gray",italic:true,interpret:true},{text:"的魔方开始",color:"gray",italic:true},{text:"正向",color:"dark_aqua",italic:true},{text:"播放动作",color:"gray",italic:true}]
