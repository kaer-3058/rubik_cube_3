...
tellraw @a [{text:"位于",color:"gray",italic:true},{nbt:"temp2",storage:"rubik_cube_3:io",color:"gray",italic:true,interpret:true},{text:"的魔方开始",color:"gray",italic:true},{text:"正序",color:"dark_aqua",italic:true},{text:"播放动作",color:"gray",italic:true}]
