...
execute as @s[tag=rubik_cube_3_west] run tag @s add rubik_cube_3_north
execute as @s[tag=rubik_cube_3_west] run tag @s remove rubik_cube_3_west

execute as @s[tag=rubik_cube_3_south] run tag @s add rubik_cube_3_west
execute as @s[tag=rubik_cube_3_south] run tag @s remove rubik_cube_3_south

execute as @s[tag=rubik_cube_3_east] run tag @s add rubik_cube_3_south
execute as @s[tag=rubik_cube_3_east] run tag @s remove rubik_cube_3_east

execute as @s[tag=temp__] run tag @s add rubik_cube_3_east
