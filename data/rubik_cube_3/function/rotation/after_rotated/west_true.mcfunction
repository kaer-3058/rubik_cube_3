...
execute as @s[tag=rubik_cube_3_down] run tag @s add rubik_cube_3_north
execute as @s[tag=rubik_cube_3_down] run tag @s remove rubik_cube_3_down

execute as @s[tag=rubik_cube_3_south] run tag @s add rubik_cube_3_down
execute as @s[tag=rubik_cube_3_south] run tag @s remove rubik_cube_3_south

execute as @s[tag=rubik_cube_3_up] run tag @s add rubik_cube_3_south
