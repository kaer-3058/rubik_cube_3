...
execute as @s[tag=rubik_cube_3_up] run tag @s add rubik_cube_3_west
execute as @s[tag=rubik_cube_3_up] run tag @s remove rubik_cube_3_up

execute as @s[tag=rubik_cube_3_east] run tag @s add rubik_cube_3_up
execute as @s[tag=rubik_cube_3_east] run tag @s remove rubik_cube_3_east

execute as @s[tag=rubik_cube_3_down] run tag @s add rubik_cube_3_east
