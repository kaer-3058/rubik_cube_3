...
execute if items entity @s weapon.offhand paper[custom_data~{rubik_cube_function:"set"}] if predicate rrr_cube_rooooooll:input/sneak at @s positioned ~-3 ~-3 ~-3 run function rubik_cube_3:item_function/use/kill_distance_3
