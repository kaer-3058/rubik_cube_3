...
execute store result score #b_0 int run data get storage rubik_cube_3:io temp_B[0]
execute store result score #b_1 int run data get storage rubik_cube_3:io temp_B[1]
execute store result score #b_2 int run data get storage rubik_cube_3:io temp_B[2]
execute store result score #b_3 int run data get storage rubik_cube_3:io temp_B[3]
execute store result score #b_4 int run data get storage rubik_cube_3:io temp_B[4]
execute store result score #b_5 int run data get storage rubik_cube_3:io temp_B[5]
execute store result score #b_6 int run data get storage rubik_cube_3:io temp_B[6]
execute store result score #b_7 int run data get storage rubik_cube_3:io temp_B[7]
execute store result score #b_8 int run data get storage rubik_cube_3:io temp_B[8]
...
execute store result storage rubik_cube_3:io temp_A[0] int 1 run scoreboard players operation #a0 int += #a2 int
...
scoreboard players operation #a0 int += #a1 int
execute store result storage rubik_cube_3:io temp_A[1] int 1 run scoreboard players operation #a0 int += #a2 int
...
execute store result storage rubik_cube_3:io temp_A[2] int 1 run scoreboard players operation #a_0 int += #a_2 int
...
scoreboard players operation #a2 int *= #b_6 int
scoreboard players operation #a0 int += #a1 int
execute store result storage rubik_cube_3:io temp_A[3] int 1 run scoreboard players operation #a0 int += #a2 int
...
scoreboard players operation #a2 int *= #b_7 int
scoreboard players operation #a0 int += #a1 int
execute store result storage rubik_cube_3:io temp_A[4] int 1 run scoreboard players operation #a0 int += #a2 int
...
execute store result storage rubik_cube_3:io temp_A[5] int 1 run scoreboard players operation #a_3 int += #a_5 int
...
scoreboard players operation #a2 int *= #b_6 int
scoreboard players operation #a0 int += #a1 int
execute store result storage rubik_cube_3:io temp_A[6] int 1 run scoreboard players operation #a0 int += #a2 int
...
scoreboard players operation #a2 int *= #b_7 int
scoreboard players operation #a0 int += #a1 int
execute store result storage rubik_cube_3:io temp_A[7] int 1 run scoreboard players operation #a0 int += #a2 int
...
execute store result storage rubik_cube_3:io temp_A[8] int 1 run scoreboard players operation #a_6 int += #a_8 int
