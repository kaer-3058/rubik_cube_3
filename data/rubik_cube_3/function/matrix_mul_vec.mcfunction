...
execute store result score #d_0 int run data get storage rubik_cube_3:io temp_D[0] 1000000
execute store result score #d_1 int run data get storage rubik_cube_3:io temp_D[1] 1000000
execute store result score #d_2 int run data get storage rubik_cube_3:io temp_D[2] 1000000
...
execute store result storage rubik_cube_3:io temp_D[0] double .000001 run scoreboard players operation #c0 int += #c2 int
...
scoreboard players operation #c2 int *= #d_2 int
scoreboard players operation #c0 int += #c1 int
execute store result storage rubik_cube_3:io temp_D[1] double .000001 run scoreboard players operation #c0 int += #c2 int
...
scoreboard players operation #c2 int *= #d_2 int
scoreboard players operation #c0 int += #c1 int
execute store result storage rubik_cube_3:io temp_D[2] double .000001 run scoreboard players operation #c0 int += #c2 int
