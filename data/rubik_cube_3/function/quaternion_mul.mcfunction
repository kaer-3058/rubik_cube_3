...
execute store result score #q1_w int run data get storage rubik_cube_3:io temp_q1[3] 10000

execute store result score #q2_x int run data get storage rubik_cube_3:io temp_q2[0] 10000
execute store result score #q2_y int run data get storage rubik_cube_3:io temp_q2[1] 10000
execute store result score #q2_z int run data get storage rubik_cube_3:io temp_q2[2] 10000
execute store result score #q2_w int run data get storage rubik_cube_3:io temp_q2[3] 10000
