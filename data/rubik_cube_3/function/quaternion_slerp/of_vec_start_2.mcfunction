...
#计算：function rubik_cube_3:quaternion_slerp/of_vec_start_2/start
...
execute store result score #input.sqrt int run scoreboard players operation #tempa int += #tempc int
function rubik_cube_3:quaternion_slerp/sqrt
scoreboard players operation #temp_abs_A int = #output.sqrt int

#|B|
scoreboard players operation #tempa int = #vec2_t int
scoreboard players operation #tempb int = #vec2_x int
scoreboard players operation #tempc int = #vec2_y int
scoreboard players operation #tempa int *= #tempa int
scoreboard players operation #tempb int *= #tempb int
scoreboard players operation #tempc int *= #tempc int
scoreboard players operation #tempa int += #tempb int
execute store result score #input.sqrt int run scoreboard players operation #tempa int += #tempc int
function rubik_cube_3:quaternion_slerp/sqrt
scoreboard players operation #temp_abs_B int = #output.sqrt int
...
scoreboard players operation #tempk int = #temp_abs_A int
scoreboard players operation #tempk int *= #temp_abs_B int
scoreboard players operation #tempk int /= 10000 const
scoreboard players operation #temp_a int /= #tempk int
...
execute store result storage rubik_cube_3:io temp2 double .00000001 run scoreboard players operation #temp_1_t int -= #vec_slerp_t int
...
scoreboard players operation #vec1_a int /= #temp_abs_A int
scoreboard players operation #vec1_b int /= #temp_abs_A int
scoreboard players operation #vec1_c int /= #temp_abs_A int
scoreboard players operation #vec1_a int *= 10000 const
scoreboard players operation #vec1_b int *= 10000 const
scoreboard players operation #vec1_c int *= 10000 const

scoreboard players operation #vec2_t int /= #temp_abs_B int
scoreboard players operation #vec2_x int /= #temp_abs_B int
scoreboard players operation #vec2_y int /= #temp_abs_B int
scoreboard players operation #vec2_t int *= 10000 const
scoreboard players operation #vec2_x int *= 10000 const
scoreboard players operation #vec2_y int *= 10000 const
...
execute store result score #temo_u_vec_a int run scoreboard players operation #vec1_a int /= #temp_temp_sin_theta int
execute store result score #temo_u_vec_b int run scoreboard players operation #vec1_b int /= #temp_temp_sin_theta int
execute store result score #temo_u_vec_c int run scoreboard players operation #vec1_c int /= #temp_temp_sin_theta int

##对长度做线性插值

scoreboard players operation #temp_abs_A int *= #temp_1_t int
scoreboard players operation #temp_abs_B int *= #vec_slerp_t int
scoreboard players operation #temo_r int = #temp_abs_A int
scoreboard players operation #temo_r int += #temp_abs_B int

##最终插值点

#|u(t)|
scoreboard players operation #tempa int = #temo_u_vec_a int
scoreboard players operation #tempb int = #temo_u_vec_b int
scoreboard players operation #tempc int = #temo_u_vec_c int
scoreboard players operation #tempa int *= #tempa int
scoreboard players operation #tempb int *= #tempb int
scoreboard players operation #tempc int *= #tempc int
scoreboard players operation #tempa int += #tempb int
execute store result score #input.sqrt int run scoreboard players operation #tempa int += #tempc int
function rubik_cube_3:quaternion_slerp/sqrt
scoreboard players operation #temp_abs_u int = #output.sqrt int

scoreboard players operation #temo_r int /= #temp_abs_u int

#输出
execute store result storage rubik_cube_3:io vec_C[0] double .00000001 run scoreboard players operation #temo_u_vec_a int *= #temo_r int
execute store result storage rubik_cube_3:io vec_C[1] double .00000001 run scoreboard players operation #temo_u_vec_b int *= #temo_r int
execute store result storage rubik_cube_3:io vec_C[2] double .00000001 run scoreboard players operation #temo_u_vec_c int *= #temo_r int
